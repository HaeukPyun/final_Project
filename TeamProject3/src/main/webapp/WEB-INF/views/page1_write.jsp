...
<body>
	...
	<section class="section">
			...
			<hr align="left">
			<h2>고객 숙지 사항</h2>
		<%-- 	<c:url var="insertUrl" value="/page1_Insert" />
	<form:form commandName="infoTO" action="${insertUrl}" name="infoTO" method="post">
			<form method="POST" action="<%=request.getContextPath()%>/board?action=write.do">
	<table>
		<tr>
			<th width="100">작성자</th>
			<td><form:input path="writer" id="writer" size="20" maxlength="100" name="writer" value="관리자"/></td>
		</tr>
		<tr>
			<th>제목</th>
			<td><form:input path="title" id="title" size="63" maxlength="500" name="title" placeholder="제목을 입력해주세요"/></td>
		</tr>
		<tr>
			<th>내용</th>
			<td><form:textarea path="content" id="content" name="content" rows="10" cols="100" maxlength="4000" placeholder="내용을 입력해주세요"/></textarea></td>
		</tr>
<!-- 		<tr> -->
<!-- 			<th>비밀번호</th> -->
...
<form name="form1" method="post" action="${path}/myapp/page1_Insert">
    <div>
        작성자
        <input name="writer" id="writer" value="관리자">
    </div>
    <div>
        제목
