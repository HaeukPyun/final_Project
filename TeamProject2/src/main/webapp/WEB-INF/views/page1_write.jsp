...
$(document).ready(function(){
	$("#btnDelete").click(function(){
        if(confirm("삭제하시겠습니까?")){
            document.form.action = "${path}/myapp/boardDelete.do";
...
<body>
	...
	<section class="section">
		<article id="section1">
			...
			<form name="infoTO" method="post">
				<%-- 			<form method="POST" action="<%=request.getContextPath()%>/board?action=write.do"> --%>
				<table>
					<tr>
						<th width="100">작성자</th>
						<td><input path="writer" id="writer" size="20"
							maxlength="100" name="writer" value="관리자" /></td>
					</tr>
					<tr>
						<th>제목</th>
						<td><input path="title" id="title" size="63" maxlength="500"
							name="title" placeholder="제목을 입력해주세요" /></td>
					</tr>
					<tr>
						<th>내용</th>
						<td><textarea path="content" id="content" name="content"
								placeholder="작성자를 입력해주세요" rows="10" cols="100" maxlength="4000" /></textarea></td>
					</tr>
					<!-- 		<tr> -->
					<!-- 			<th>비밀번호</th> -->
					...
					<tr>
						...
						<td><button type="button" id="btnUpdate">등록</button></td>
						<td><button type="button" id="btnDelete">삭제</button></td>
						<td><a href="<%=request.getContextPath()%>/page1">목록</a></td>
					</tr>
				</table>
			</form>
			<br>
