						...
						<div class="row no-gutters mb-5">
							<div class="col-md-7">
								<div class="contact-wrap w-100 p-md-5 p-4">
									...
									<div id="form-message-success" class="mb-4">발견한 캠핑장을 소개해
										주세요</div>
									<form method="POST" id="contactForm" name="contactForm"
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="label" for="camp_name">캠핑장 이름</label> <input
											...
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="subject">부대시설</label> <input
														type="text" class="form-control" name="subject"
														id="subject" placeholder="시설 소개">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="#">주소</label>
													<textarea name="camp_address" class="form-control"
														id="camp_address" cols="30" rows="4" readonly="readonly"></textarea>
												</div>
												<div class="form-group">
													<label class="label" for="#">캠핑장 설명</label>
													<textarea name="camp_content" class="form-control"
														id="camp_content" cols="30" rows="4"
										...
										<input type="hidden" id="lat"> <input type="hidden"
											id="lng">
									</form>
								</div>
							</div>
