 ...
 * Generated at: 2020-08-26 03:41:23 UTC
...
public final class page5_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <title>camper.page5</title>\r\n");
      ...
      out.write("   }\r\n");
      out.write("   \r\n");
      out.write("    .imgs_wrap img {\t/* tgkim 200804 */\r\n");
      out.write("    \tmax-width: 33%;\r\n");
      out.write("    \t\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    #map{\r\n");
      ...
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    .selProductFile:hover {\r\n");
      out.write("    \tbackground-image: url('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${path }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/resources/images/delete.png');\r\n");
      out.write("    \t\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    .dotOverlay{\r\n");
      ...
      out.write("\t$(\"#input_imgs\").trigger('click');\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function deleteImageAction(index){\r\n");
      out.write("\tself_files.splice(index, 1);\r\n");
      out.write("\t\r\n");
      out.write("\tvar img_id = \"#img_id_\" + index;\r\n");
      out.write("\t$(img_id).remove();\r\n");
      out.write("\t\r\n");
      out.write("\tif(self_files.length <=0){\r\n");
      out.write("\t\t$(\"#uploadBtn\").remove();\t\t//사진 업로드 a태그 삭제\r\n");
      out.write("\t\t$(\"#divMessage\").remove();\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t//이미지 정보를 초기화\r\n");
      out.write("\t\r\n");
      out.write("\tself_files = [];\r\n");
      ...
      out.write("\t\talert(\"사진은 3개 까지만 등록 가능합니다.\");\r\n");
      out.write("\t}else{\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tself_files.push(f);\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar reader = new FileReader();\r\n");
      out.write("\t\treader.onload = function(e){\t\t// 나중에 서버에 파일 이름을 아이디나 서버 폴더 이름을 사용자아이디로 생성해서 사진을 넣어야한다.\r\n");
      out.write("\t\t\tvar html = \"<a href=\\\"javascript:\\\" onclick=\\\"deleteImageAction(\"+index+\")\\\" id=\\\"img_id_\"+index+\"\\\"><img src=\\\"\" + e.target.result + \"\\\" data-file = '\"+f.name+\"' class='selProductFile' title = '클릭하면 이미지가 지워집니다'></a>\";\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t}else{\r\n");
      out.write("\t\tvar atag=\"<a href='javascript:' class='btn btn-primary' onclick='submitAction();'>사진 업로드</a>\";\r\n");
      out.write("\t\t$(\"#uploadBtn\").append(atag);\r\n");
      out.write("\t\tvar divMessage = \"<div id='divMessage'>이미지를 삭제하려면 이미지를 클릭해 주세요.</div>\";\r\n");
      out.write("\t\t$(\"#imgs_wrap\").append(divMessage);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      ...
      out.write("\t\r\n");
      out.write("\tfor(var i=0, len = sel_files.length; i<len; i++){\r\n");
      out.write("\t\tvar name = \"image_\" + i;\r\n");
      out.write("\t\tdata.append(name, sel_files[i]);\r\n");
      out.write("\t}\r\n");
      out.write("\tdata.append(\"image_count\", sel_files.length);\r\n");
      out.write("\t\r\n");
      out.write("\tvar xhr = new XMLHttpRequest();\r\n");
      out.write("\txhr.open(\"POST\", \"\") // 빈칸에 포스트로 이동할 위치 넣기\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div id=\"map\">            <!-- 지도 추가  -->\r\n");
      out.write("                          \t\t\t\t\t\t\t<!--  <div id=\"clickLatlng\"></div> -->\r\n");
      out.write("                               \t\t\t\t\t\t</div>\r\n");
      out.write("                               \t\t\t\t\t\t<a href=\"javascript:\" onclick=\"routeMap(false);\" class=\"btn btn-primary\">위치로 표시하기</a>\r\n");
      out.write("                               \t\t\t\t\t\t<a href=\"javascript:\" onclick=\"routeMap(true);\" class=\"btn btn-primary\">경로로 표시하기</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"javascript:\" onclick=\"fileUploadAction();\" class=\"btn btn-primary\">사진 등록</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input hidden=\"\" type=\"file\" id=\"input_imgs\" multiple/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"imgs_wrap\" id=\"imgs_wrap\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img id=\"img\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- <a href=\"javascript:\" class=\"btn btn-primary\" onclick=\"submitAction();\">사진 업로드</a> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<a id=\"uploadBtn\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"submit\" value=\"캠핑장 등록하기\" class=\"btn btn-primary\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- <div class=\"col-md-12 d-flex align-items-stretch\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div id=\"map\">\t\t\t\t지도 추가 \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div id=\"clickLatlng\"></div>\r\n");
      out.write("\t\t\t\t          \t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div> -->\r\n");
      ...
      out.write("  <script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${path}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/resources/js/daum-map.js?version=1211233111\"></script>\r\n");
      out.write("  <script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${path}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005fset_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/page5.jsp(5,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("path");
      // /WEB-INF/views/page5.jsp(5,0) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/page5.jsp(5,0) '${pageContext.request.contextPath }'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${pageContext.request.contextPath }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
